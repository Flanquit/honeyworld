...
<div class="rev_slider_wrapper bg-arrows">
    <div id="rev_slider" class="rev_slider fullscreenbanner">
       <ul>
        ...
        {{-- {{ asset('storage/'.$HeadingTwo->HeadingTwo)}} --}}
          ...
          <li data-delay="5000" data-transition="slotzoom-horizontal" data-slotamount="7" data-masterspeed="500" data-fsmasterspeed="500">
             <img src="{{ asset('storage/'.$HeadingThree)}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
          ...
          <li data-delay="5000" data-transition="slotzoom-horizontal" data-slotamount="7" data-masterspeed="500" data-fsmasterspeed="500">
             <img src="{{ asset('storage/'.$HeadingFour)}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
       ...
       <div class="row mt-30">
          <div class="col-md-3 col-sm-12 col-12">
             <div class="service-block">
                <img src="{{ asset('storage/'.$ContentTwo)}}" alt="img">
                <div class="service-block-content">
                   <h4>Our Products</h4>
                   <p>Bee and Honey Products.</p>
                   <a href="{{ url('Products') }}" class="service-block-content-button"><i class="fas fa-arrow-right"></i></a>
                </div>
             </div>
          </div>
          ...
          <div class="col-md-3 col-sm-12 col-12">
             <div class="service-block">
                <img src="{{ asset('storage/'.$ContentThree)}}" alt="img">
                <div class="service-block-content">
                   <h4>Our Services </h4>
                   <p>Bee Removal, Keeping & Training..</p>
                   <a href="{{ url('BeeRemoval') }}" class="service-block-content-button"><i class="fas fa-arrow-right"></i></a>
                </div>
             </div>
          </div>
          <div class="col-md-3 col-sm-12 col-12">
             <div class="service-block">
                <img src="{{ asset('storage/'.$ContentFour)}}" alt="img">
                <div class="service-block-content">
                   <h4>Our Strategy</h4>
                   <p>Out-Grower Scheme.</p>
                   <a href="{{ url('Sustainable') }}" class="service-block-content-button"><i class="fas fa-arrow-right"></i></a>
                </div>
             </div>
          </div>
          <div class="col-md-3 col-sm-12 col-12">
             <div class="service-block">
                <img src="{{ asset('storage/'.$HeaderImageUrl)}}" alt="img">
                <div class="service-block-content">
                   <h4>Our Impact </h4>
       ...
       <div class="row">
          <div class="col-md-5 col-sm-5 col-12">
             <div class="section-heading">
                ...
                <h4 class="semi-bold"> Honeyworld Zimbabwe (Private) Limited (HWZ), is a social enterprise.</h4>
             </div>
          ...
          <div class="col-md-6 col-sm-6 col-12 offset-md-1"><img src="img/logos/who.jpg" class="position-relative extra-rounded-border shadow-primary z-index-9 mt-30-xs" alt="img"></div>
       </div>
    </div>
 </div>
 ...
 <div class="section-block-parallax jarallax black-overlay-70" data-jarallax data-speed="0.6" style="background-image: url('img/content/business/bg3.jpg');">
    <div class="container">
          ...
          <div class="owl-carousel owl-theme testmonials-carousel">
             <div class="testmonial-box">
                ...
                <div class="testmonial-box-content">
                   <h3>Latest Events</h3>
                   <strong>Asian Hornet found in Ashford in Kent</strong>
                   <p>An Asian Hornet has been found and captured in Ashford in Kent. This is the third confirmed sighting in 2019..</p>
             ...
             <div class="testmonial-box">
                <div class="testmonial-box-icon"><img src="img/logos/british.jpg" alt="img"></div>
                <div class="testmonial-box-content">
                   <h3>Twitter</h3>
                   <strong>Tweets by British Bee</strong>
                   <p>BBKA @britishbee
                      This is the page for the British Beekeepers' Association, a national charity supporting bees and beekeepers..</p>
                   <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fas fa-star"></i></div>
                </div>
             </div>
             <div class="testmonial-box">
                <div class="testmonial-box-icon"><img src="img/logos/honeyworld.logo.jpg" alt="img"></div>
                <div class="testmonial-box-content">
                   <h3>Facebook Feeds</h3>
                   <strong>HoneyWorld Zimbabwe</strong>
                   <p>The vision of HWZ is to see rural communities in Zimbabwe gaining sustainable income from beekeeping enterprise as a social business...</p>
                   <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fas fa-star"></i></div>
                </div>
             </div>
          </div>
    ...
    <div class="container">
       ...
       <div class="row mt-40">
          <div class="col-md-4 col-sm-4 col-12">
             <div class="blog-grid">
                <img src="img/logos/news1.jpg" alt="blog">
                <div class="blog-team-box">
                   <h6>Aug 24, 2019</h6>
                </div>
                <h4><a href="#">Apiary and Education</a></h4>
                <p>We currently use our Apiary only 10 - 12 days maximum throughout the year to conduct beekeeping exams and assessments...</p>
                <a href="#" class="button-simple-primary mt-20">Read More <i class="fas fa-arrow-right"></i></a>
             </div>
          </div>
          <div class="col-md-4 col-sm-4 col-12">
             <div class="blog-grid">
                <img src="img/logos/news2.jpg" alt="blog">
                <div class="blog-team-box">
                   <h6>Aug 13, 2019</h6>
                </div>
                <h4><a href="#">Identifying Asian Hornet</a></h4>
                <p>Become a citizen scientist and learn how to identify this invasive species that is a threat to UK honeybees.</p>
                <a href="#" class="button-simple-primary mt-20">Read More <i class="fas fa-arrow-right"></i></a>
             </div>
          </div>
          <div class="col-md-4 col-sm-4 col-12">
             <div class="blog-grid">
                <img src="img/logos/news3.jpg" alt="blog">
                <div class="blog-team-box">
                   <h6>Oct 30, 2018</h6>
                </div>
                <h4><a href="#">Spring Convention 2020</a></h4>
                <p>SEE YOU AT THE BBKA SPRING CONVENTION 3,4,5 APRIL 2020. Location: Harper Adams University, Newport, Shopshire, TF10 8NB</p>
                <a href="#" class="button-simple-primary mt-20">Read More <i class="fas fa-arrow-right"></i></a>
             </div>
          </div>
       </div>
