            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Add') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-4">PageNae : <input type="text" name="pagename" id="" value="{{ $PageName }}"></div>
                        </div>
                        <br/>
                        ...
                        <div class="row">
                            &nbsp;&nbsp; Content :&nbsp;&nbsp; <textarea name="content" id="" cols="100" rows="20" value="{{ $ContentOne  }}"></textarea>
                        </div>
